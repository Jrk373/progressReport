...
```{r Data_Load1, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
# Load data
...
Provider_ShortName_out <- (c("Nine", "One", "Two", "Seven", "Five", "Six", "Three", "Eight", "Four"))
#
...
AZ_County_Map <- (c("Apache", "Coconino", "Mohave", 
                    "Navajo", "Yavapai"))
AZ_County_Map_out <- (c("Alderan", "Naboo", "Tatooine", 
                    "Dagobah", "Endor"))
#
...
```{r Data_GlblMmbrshp, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r DATA_AllProvComplianceTable, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r DATA_IndivProvComplianceTable, include=FALSE, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
# Calculate performance levels
...
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_CountyDistribution.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_CountyDistribution.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_GenderDistribution.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_GenderDistribution.png", width = 500, height = 500)
```
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Fig_PopPyramid.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Fig_PopPyramid.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_Allo_v_Assignment.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_Alloc_v_Assignment.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_AllProvPerformance.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_AllProvPerformance.png", width = 500, height = 500)
```
<br>
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Fig_AllProvLollipop.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Fig_AllProvLollipop.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_AMM2Performance.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_AMM2Performance.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_FUH7Performance.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_FUH7Performance.png", width = 500, height = 500)
...
# Creates undated dashboard image
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_db_Tab_HDOPerformance.png", width = 500, height = 500)

# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-03-01_Tab_HDOPerformance.png", width = 500, height = 500)
