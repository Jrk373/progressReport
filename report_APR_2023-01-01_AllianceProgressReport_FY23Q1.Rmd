...
# Load data
<<<<<<< HEAD
GlblMmbrshp <- read_xlsx("./data/data_original_glblmbrs_2023-01-02_globalMembersRoster.xlsx", sheet = "Data_Original_MemberRoster")
VBP_Rep_Comb <- read_csv("./data/data_original_vbpbhh_2022-12-16_allProvidersCombined.csv")
...
VBP_Report_Date = "2022-10-31" #claimsAdjudicated Through Date
...
AllAlliancePerformance <- Tab_PercentCompliant %>% 
  filter(Data.Period == Data.Period) %>% 
=======
  filter(Data.Period == VBP_Report_Date) %>%
  filter(SubMeasure.ID %in% c("AMM2","FUH7", "HDO")) %>% 
  mutate(PercentCompliant = AdaptedCompliant/TotalEligible) %>%   
...
>>>>>>> fccb0280c37fd4cb1b1395cf8edd3ccb2d76961a
  ...
  select(Health.Home.Name,
         ...
         PerformanceLevel)
# Export the table as a csv for reference
write.csv(IndivAlliancePerformance_AMM2, "./data/output/2023-01-01_IndivAlliancePerformance_AMM2.csv")
...
>>>>>>> fccb0280c37fd4cb1b1395cf8edd3ccb2d76961a
  ...
  select(Health.Home.Name,
         ...
         PerformanceLevel)
# Export the table as a csv for reference
write.csv(IndivAlliancePerformance_FUH7, "./data/output/2023-01-01_IndivAlliancePerformance_FUH7.csv")
#HDO
...
>>>>>>> fccb0280c37fd4cb1b1395cf8edd3ccb2d76961a
  ...
  select(Health.Home.Name,
         ...
         PerformanceLevel)
# Export the table as a csv for reference
write.csv(IndivAlliancePerformance_HDO, "./data/output/2023-01-01_IndivAlliancePerformance_HDO.csv")
```
...
Tab_CountyDistribution <- CountyDistribution %>% 
  ...
  tab_header(
    ...
    subtitle = md("As of December 31, 2022")
  ) %>% 
  ...
  cols_width(`County of Residence` ~ px(220),
             Members ~ px(100),
             Percent ~ px(100)) %>% 
  tab_source_note(source_note = md("*SOURCE: BCBSAZ Global Members, extracted 12/31/2022*")) %>% 
  tab_style(
    style = list(
...
gtsave(Tab_CountyDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Tab_CountyDistribution.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_CountyDistribution, filename = "images/image_2023-01-01_Tab_CountyDistribution.png")
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_GenderDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Tab_GenderDistribution.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_GenderDistribution, filename = "images/image_2023-01-01_Tab_GenderDistribution.png")
#
...
# creates dated image for tracking and filing in SharePoint
# date must be updated for each monthly report
dev.print(device = png, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Fig_PopPyramid.png", width = 500, height = 500)
# creates dated image for tracking and filing in R project folder
# date must be updated for each monthly report
dev.print(device = png, filename = "./images/image_2023-01-01_Fig_PopPyramid.png", width = 500, height = 500)
```
...
Tab_Alloc_v_Assignment <- ContractAlloc_v_Assignment %>% 
  gt() %>% 
    tab_header(
      ...
      subtitle = md("*Compared with BCBSAZ AutoAssignment, December 31, 2022*")
      ) %>% 
    ...
    opt_align_table_header(align = "left") %>% 
    tab_source_note(
        source_note = md("*Alliance Allocation based on Contract Year 2022-2023 <br> BCBSAZ Auto Assignment based on Global Members, extracted 12/31/2022*")
        ) %>% 
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_Alloc_v_Assignment, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Tab_Alloc_v_Assignment.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_Alloc_v_Assignment, filename = "images/image_2023-01-01_Tab_Alloc_v_Assignment.png")
...
gt() %>% 
  tab_header(
    ...
    subtitle = md("*January 2022 - October 2022*")
  ) %>% 
  ...
  tab_source_note(
    source_note = md("*SOURCE: BCBSAZ VBP Performance Reports, Claims Adjudicated Through October 31, 2022*")
  ) %>% 
  tab_style(
    style = list(
      cell_fill(color = "#4b605e"),
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_AllProvPerformance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Tab_AllProvPerformance.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_AllProvPerformance, filename = "images/image_2023-01-01_Tab_AllProvPerformance.png")
...
>>>>>>> fccb0280c37fd4cb1b1395cf8edd3ccb2d76961a
  ...
  labs(title = "Alliance Provider Target Measure Compliance",
       ...
       caption = "Data source: BCBSAZ VBP Report, Claims Adjudicated Through Oct. 2022")
#
Fig_AllProvLollipop
#
# Creates undated dashboard image for SharePoint
...
# creates dated image for tracking and filing in SharePoint
# date must be updated for each monthly report
dev.print(device = png, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-01-01_Fig_AllProvLollipop.png", width = 500, height = 500)
# creates dated image for tracking and filing in R project folder
# date must be updated for each monthly report
dev.print(device = png, filename = "./images/image_2023-01-01_Fig_AllProvLollipop.png", width = 500, height = 500)
```
...
tab_header(
    ...
    subtitle = md("*January 2022 - October 2022* <br> NCQA Mean = 57.30%")
  ) %>% 
...
tab_header(
    ...
    subtitle = md("*January 2022 - October 2022* <br> NCQA Mean = 39.36%")
  ) %>% 
  fmt_percent(columns = c("PercentCompliant"), 
            decimals = 2,
            force_sign = FALSE) %>% 
...
tab_header(
    ...
    subtitle = md("*January 2022 - October 2022* <br> NCQA Mean = 93% Compliant")
  ) %>% 
  fmt_percent(columns = c("PercentCompliant"), 
            decimals = 2,
            force_sign = FALSE) %>% 
