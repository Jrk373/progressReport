...
write.csv(Alloc_v_EnrolledPercentDiff, "./data/output/Alloc_v_EnrolledPercentDiff.csv")
```
...
# Export the table as a csv for reference
write.csv(DemoTable_SexByAgeGroup, "./data/output/DemoTable_SexByAgeGroup.csv")
```
...
CountyDistribution <- ActiveNAZMmbrshp %>% 
  ...
  mutate(Percent = (Members / (sum(Members)))) 
# Export the table as a csv for reference
write.csv(CountyDistribution, "./data/output/CountyDistribution.csv")
```
...
# Export the table as a csv for reference
write.csv(Tab_PercentCompliant, "./data/output/Tab_PercentCompliant.csv")
```
