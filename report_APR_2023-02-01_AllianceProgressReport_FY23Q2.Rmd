...
# Load data
GlblMmbrshp <- read_xlsx("./data/data_original_glblmbrs_2023-02-21_globalMembersRoster.xlsx", sheet = "Data_Original_MemberRoster")
VBP_Rep_Comb <- read_csv("./data/data_original_vbpbhh_2023-01-30_allProvidersCombined.csv")
...
Data.Period = "2022-11-30" #claimsAdjudicated Through Date
Reportasof = "2022-01-30"
ProgressReportDate = "2023-02-01"
#Date member roster was extracted from HCAGlobal
Members_Report_Date = "2022-02-21" 
#
...
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(ActiveNAZMmbrshp, "./data/output/2023-02-01_ActiveNAZMembership.csv")
=======
write.csv(ActiveNAZMmbrshp, "./data/output/2023-03-01_ActiveNAZMembership.csv")
>>>>>>> fccb0280c37fd4cb1b1395cf8edd3ccb2d76961a:report_APR_2023-03-01_AllianceProgressReport_FY23Q2.Rmd
...
# Export to CSV file
write.csv(HCA_AutoEnrolled, "./data/output/2022-01-01_HCA_AutoEnrolled.csv")
...
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(ContractAlloc_v_Assignment, "./data/output/2023-02-01_ContractAlloc_v_Assignment.csv")
=======
...
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(Alloc_v_EnrolledPercentDiff, "./data/output/2023-02-01_Alloc_v_EnrolledPercentDiff.csv")
=======
...
# Export the table as a csv for reference
write.csv(Tab_Gender, "./data/output/2023-02-01_Tab_Gender.csv")
```
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(DemoTable_SexByAgeGroup, "./data/output/2023-02-01_DemoTable_SexByAgeGroup.csv")
=======
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(CountyDistribution, "./data/output/2023-02-01_CountyDistribution.csv")
=======
...
# Export the table as a csv for reference
write.csv(Tab_PercentCompliant, "./data/output/2023-02-01_Tab_PercentCompliant.csv")
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(AllAlliancePerformance, "./data/output/2023-02-01_Tab_AllAlliancePerformance.csv")
```
...
#   mutate(PerformanceLevel = PercentCompliant-AdaptedNCQAMean) %>% 
#   #mutate(Data.Period = as.Date(Data.Period)) %>% 
#   select(Health.Home.Name,
#          Provider_Shortname, 
#          SubMeasure.ID,
#          AdaptedCompliant,
#          TotalEligible,
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(IndivAlliancePerformance_AMM2, "./data/output/2023-02-01_IndivAlliancePerformance_AMM2.csv")
=======
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(IndivAlliancePerformance_FUH7, "./data/output/2023-02-01_IndivAlliancePerformance_FUH7.csv")
=======
...
# Export the table as a csv for reference
<<<<<<< HEAD:report_APR_2023-02-01_AllianceProgressReport_FY23Q2.Rmd
write.csv(IndivAlliancePerformance_HDO, "./data/output/2023-02-01_IndivAlliancePerformance_HDO.csv")
=======
...
gtsave(Tab_CountyDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_CountyDistribution.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_CountyDistribution, filename = "images/image_2023-02-01_Tab_CountyDistribution.png")
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_GenderDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_GenderDistribution.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_GenderDistribution, filename = "images/image_2023-02-01_Tab_GenderDistribution.png")
#
...
Fig_PopPyramid <- ggplot(DemoTable_SexByAgeGroup, aes(y = Age_Group, x = n, fill = sex)) +
  ...
  labs(
    ...
    subtitle = "As of February 21, 2023",
    caption = "Source: BCBSAZ Global Members, Extracted 02/21/2023"
  ) +
  theme_classic() +
  theme(
...
# creates dated image for tracking and filing in SharePoint
# date must be updated for each monthly report
dev.print(device = png, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Fig_PopPyramid.png", width = 500, height = 500)
# creates dated image for tracking and filing in R project folder
# date must be updated for each monthly report
dev.print(device = png, filename = "./images/image_2023-02-01_Fig_PopPyramid.png", width = 500, height = 500)
```
...
Tab_Alloc_v_Assignment <- ContractAlloc_v_Assignment %>% 
  gt() %>% 
    tab_header(
      ...
      subtitle = md("*Compared with BCBSAZ AutoAssignment, February 21, 2023*")
      ) %>% 
    ...
    opt_align_table_header(align = "left") %>% 
    tab_source_note(
        source_note = md("*Alliance Allocation based on Contract Year 2022-2023 <br> BCBSAZ Auto Assignment based on Global Members, extracted 02/21/2023*")
        ) %>% 
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_Alloc_v_Assignment, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_Alloc_v_Assignment.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_Alloc_v_Assignment, filename = "images/image_2023-02-01_Tab_Alloc_v_Assignment.png")
...
gt() %>% 
  ...
  fmt_percent(columns = c("PerformanceLevel"), 
              ...
              force_sign = TRUE) %>% 
  opt_align_table_header(align = "left") %>% 
  cols_label(SubMeasure.ID = "NCQA Measure",
   ...
   cols_width(SubMeasure.ID ~ px(110),
  ...
  tab_source_note(
    source_note = md("*SOURCE: BCBSAZ VBP Performance Reports, Claims Adjudicated Through November 30, 2022*")
  ) %>% 
  tab_style(
    style = list(
      cell_fill(color = "#4b605e"),
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_AllProvPerformance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_AllProvPerformance.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_AllProvPerformance, filename = "images/image_2023-02-01_Tab_AllProvPerformance.png")
...
Fig_AllProvLollipop <- Tab_PercentCompliant %>% 
  ...
  geom_point(aes(size = PercentTotalElig*10),
                 color = "#4b605e",
            ) +
  ...
  labs(title = "Alliance Provider Target Measure Compliance",
       ...
       caption = "Data source: BCBSAZ VBP Report, Claims Adjudicated Through Nov. 2022")
#
Fig_AllProvLollipop
#
# Creates undated dashboard image for SharePoint
...
# creates dated image for tracking and filing in SharePoint
# date must be updated for each monthly report
dev.print(device = png, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Fig_AllProvLollipop.png", width = 500, height = 500)
# creates dated image for tracking and filing in R project folder
# date must be updated for each monthly report
dev.print(device = png, filename = "./images/image_2023-02-01_Fig_AllProvLollipop.png", width = 500, height = 500)
```
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_AMM2Performance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_AMM2Performance.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_AMM2Performance, filename = "images/image_2023-02-01_Tab_AMM2Performance.png")
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_FUH7Performance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_FUH7Performance.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_FUH7Performance, filename = "images/image_2023-02-01_Tab_FUH7Performance.png")
...
# creates dated image for tracking and filing in Sharepoint
# date must be updated for each monthly report
gtsave(Tab_HDOPerformance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/image_2023-02-01_Tab_HDOPerformance.png")
# creates dated image for tracking and filing
# date must be updated for each monthly report
gtsave(Tab_HDOPerformance, filename = "images/image_2023-02-01_Tab_HDOPerformance.png")
