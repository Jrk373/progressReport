...
# Load data
GlblMmbrshp <- read_csv("C:/Users/KGLtd/OneDrive - The NARBHA Institute/ACO/Data and Reports/Alliance Progress Reports/01_report_progress_2023-02-14_allianceProgressReport_CY23Q2/data_confidential_glblmbrs_2023-02-21_globalMembersRoster.csv")
VBP_Rep_Comb <- read_csv("./data/datadata_original_vbpbhh_2023-01-30_allProvidersCombined.csv")
...
Reportasof = "2023-01-30"
ProgressReportDate = "2023-03-01"
#Date member roster was extracted from HCAGlobal
Members_Report_Date = "2023-02-21" 
#
...
# Export the table as a csv for reference
write.csv(Tab_Gender, "./data/output/2023-03-01_Tab_Gender.csv")
```
...
# Export the table as a csv for reference
write.csv(AllAlliancePerformance, "./data/output/2023-03-01_Tab_AllAlliancePerformance.csv")
```
...
Fig_PopPyramid <- ggplot(DemoTable_SexByAgeGroup, aes(y = Age_Group, x = n, fill = sex)) +
  ...
  labs(
    ...
    subtitle = "As of February 21, 2022",
...
Fig_AllProvLollipop <- Tab_PercentCompliant %>% 
  ...
  labs(title = "Alliance Provider Target Measure Compliance",
       ...
       caption = "Data source: BCBSAZ VBP Report, Claims Adjudicated Through November. 2022")
#
Fig_AllProvLollipop
#
# Creates undated dashboard image for SharePoint
