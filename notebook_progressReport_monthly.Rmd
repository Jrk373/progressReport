...
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_CountyDistribution.png", width = 500, height = 500)
```
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_GenderDistribution", width = 500, height = 500)
```
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Fig_PopPyramid.png", width = 500, height = 500)
```
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_Alloc_v_Assignment", width = 500, height = 500)
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_AllProvPerformance.png", width = 500, height = 500)
```
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Fig_AllProvLollipop.png", width = 500, height = 500)
```
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_AMM2Performance.png", width = 500, height = 500)
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_FUH7Performance.png", width = 500, height = 500)
...
# creates dated image for tracking and filing
# date must be updated for each monthly report
png(file = "./images/image_2023-03-01_Tab_HDOPerformance.png", width = 500, height = 500)
```
